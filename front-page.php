...
<!-- <?php
    $name = array('Tolu', 'Uche', 'Agatha', 'Rejoice');
            ...
            while($homePageEvents->have_posts()){
                ...
                <div class="event-summary">
                    ...
                    <span class="event-summary__month"><?php 
                        $currentMonth = new DateTime(get_field('event_date'));
                        echo $currentMonth->format('M')
                     ?></span>
                    <span class="event-summary__day"><?php echo $currentMonth->format('d') ?></span>
                    </a>
