...
function university_files(){
    wp_enqueue_script('main-university-js', '//maps.googleapis.com/maps/api/js?key=AIzaSyAQVkES-HRPa17eGXS4HYOnR5BRiF3xa3k', NULL, '1.0', true);
...
function universityMapKey($api){
    $api['key'] = 'AIzaSyAQVkES-HRPa17eGXS4HYOnR5BRiF3xa3k';
    return $api;
}
